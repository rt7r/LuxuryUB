...
@luxur.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump Catuserbot is One of the Popular LuxuryUB",
    },
)
...
@luxur.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catuserbot is One of the Popular LuxuryUB",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@luxur.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna LuxuryUB is One of the Popular LuxuryUB",
    },
)
async def nekobot(cat):
...
@luxur.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; LuxuryUB is One of the Popular LuxuryUB",
    },
)
async def nekobot(cat):
