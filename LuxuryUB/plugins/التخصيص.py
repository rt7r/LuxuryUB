...
@luxur.ar_cmd(pattern="اضف صورة (الفحص|فحص) ?(.*)")
...
@luxur.ar_cmd(pattern="اضف صورة (البنك|بنك) ?(.*)")
...
@luxur.ar_cmd(pattern="اضف صورة (الحماية|الحمايه|حماية|حمايه) ?(.*)")
...
@luxur.ar_cmd(pattern="اضف صورة (الخاص|خاص) ?(.*)")
