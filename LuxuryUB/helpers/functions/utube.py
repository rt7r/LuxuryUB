...
async def yt_search(LuxuryUB):
    try:
        LuxuryUB = urllib.parse.quote(LuxuryUB)
        html = urllib.request.urlopen(
            f"https://www.youtube.com/results?search_query={LuxuryUB}"
        )
...
"""
async def yt_data(LuxuryUB):
    params = {"format": "json", "url": LuxuryUB}
