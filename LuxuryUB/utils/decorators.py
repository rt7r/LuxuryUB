...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**تقرير خطا فـيـنيـكـس**\n\n"
            link = "[هنا](https://t.me/ee2ei)"
...
def register(**args):
    ...
    def decorator(func):
        if not disable_edited:
            luxur.add_event_handler(func, MessageEdited(**args))
        luxur.add_event_handler(func, NewMessage(**args))
        try:
