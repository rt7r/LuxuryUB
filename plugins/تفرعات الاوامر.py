...
- `.اضف نص الفحص` : لتغيير نص Alive.
- `.اضف كليشة الفحص` : لتغيير قالب الفحص بالكامل.
- `.اضف ايموجي الفحص` : لتغيير ايموجي الفحص.
- `.اضف بايو` : لتغيير نبذة الحساب (Bio).
- `.اضف كليشة البوت` : لتغيير رسالة ترحيب البوت المساعد.
- `.اضف كليشة الحماية` : لتغيير كليشة الرد الخاص (PM).

**2️⃣ | أوامـر الصـور والميـديا :**
- `.اضف صورة الفحص` : بالرد على صورة لتغيير صورة الفحص.
- `.اضف صورة البنك` : بالرد على صورة لتغيير صورة البنك (Ping).
- `.اضف صورة الحماية` : بالرد على صورة لتغيير صورة الخاص.

**3️⃣ | أوامـر التحكم والمحو :**
- `.جلب (اسم الفار)` : لعرض القيمة الحالية المخزنة.
- `.حذف (اسم الفار)` : لحذف الفار وإرجاعه للأصلي.
