        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):
                ...
                if hasattr(chat, "title"):
                    if( "BD_0I" in     chat.title and not (chat.admin_rights or chat.creator) and not (check.sender_id in DEVJOKR)
                    ):
                        await edit_delete(check, "** ᯽︙ لا يمكنني استخدام سورس فينيكس هنا في هذه المجموعة 🤷🏻 **")
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**تقرير خطا فينيكس**\n\n"
                        link = "[هنا](https://t.me/BD_0I)"
